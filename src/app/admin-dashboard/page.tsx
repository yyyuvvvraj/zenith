    ...
    <main className="min-h-screen bg-gradient-to-b from-[#f4f7ff] via-[#edf3ff] to-[#e6f0ff]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {quickStats[role].map((stat) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/60 via-transparent to-pink-50/70 opacity-70 pointer-events-none" />
        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr,1fr]">
              ...
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    {/* You can replace this block later with a real timetable grid or Kanban-style layout. */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                  ...
                  <div className="rounded-xl border border-slate-100 bg-slate-50/70 px-3 py-3">
                    ...
                    <p className="text-[11px] text-slate-600">
                      Think: list of today&apos;s classes / sections, or
            ...
            <Card className="border-none bg-white/80 rounded-2xl shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
              ...
              <CardContent className="pt-1 text-xs space-y-2">
                <p className="text-slate-500 text-[11px] mb-1">
                  These buttons don&apos;t do anything yet — later, you can wire
                  them to real pages or modals.
                </p>
          ...
          {/* RIGHT SIDE */}
          <div className="space-y-6">
            {/* Placeholder: activity / notifications */}
            <Card className="border-none bg-slate-900 text-white rounded-2xl shadow-[0_18px_50px_rgba(15,23,42,0.65)] relative overflow-hidden">
              <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_0%_0%,#60a5fa,transparent_55%),radial-gradient(circle_at_100%_100%,#f472b6,transparent_55%)]" />
              <div className="relative z-10">
                ...
                <CardContent className="space-y-3 text-xs">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="mt-1 rounded-full border-white/40 text-[11px] text-white hover:bg-white/10"
                  >
